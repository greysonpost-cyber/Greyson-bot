...
const commandPermissions = require('../commands/roles/command-permissions');
const rolePermissions = require('../commands/roles/role-permissions');
...
module.exports = {
    ...
    async execute(interaction, client) {
        try {
            ...
            if (customId.startsWith('permission_commands:')) return commandPermissions.handleInteraction(interaction, client);
            if (customId.startsWith('role_permissions_manage:')) return rolePermissions.handleInteraction(interaction, client);
        } catch (err) {
